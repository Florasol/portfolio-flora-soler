...
function APropos() {
    const aproposData = [
		{
			title: 'Fiabilité',
			icon: <img className="apropos-icon" src="https://portfolio-flo-bucket.s3.eu-north-1.amazonaws.com/apropos/handshake.png" alt="Icone Fiable" />,
			content:
		...
		{
			title: 'Respect',
			icon: <img className="apropos-icon" src="https://portfolio-flo-bucket.s3.eu-north-1.amazonaws.com/apropos/inclusive.png" alt="Icone inclusif" />,
			content:
		...
		{
			title: 'Service',
			icon: <img className="apropos-icon" src="https://portfolio-flo-bucket.s3.eu-north-1.amazonaws.com/apropos/service.png" alt="Icone coeur mains service" />,
			content:
		...
		{
			title: 'Sécurité',
			icon: <img className="apropos-icon" src="https://portfolio-flo-bucket.s3.eu-north-1.amazonaws.com/apropos/lockicon.png" alt="Sécurité Icone" />,
			content: (
				<>
